...
namespace Raven.Server.Documents.PeriodicBackup
{
    public class BackupUploader
    {
        ...
        public bool AnyUploads => Raven.Client.Documents.Operations.Backups.BackupConfiguration.CanBackupUsing(_settings.S3Settings)
                                  || Raven.Client.Documents.Operations.Backups.BackupConfiguration.CanBackupUsing(_settings.GlacierSettings)
                                  || Raven.Client.Documents.Operations.Backups.BackupConfiguration.CanBackupUsing(_settings.AzureSettings)
                                  || Raven.Client.Documents.Operations.Backups.BackupConfiguration.CanBackupUsing(_settings.GoogleCloudSettings)
                                  || Raven.Client.Documents.Operations.Backups.BackupConfiguration.CanBackupUsing(_settings.FtpSettings);
        ...
        {
            if (Raven.Client.Documents.Operations.Backups.BackupConfiguration.CanBackupUsing(settings) == false)
                return;
